...
namespace BepuPhysics.Constraints
{
        ...
        where TSolveAccessFilterD : unmanaged, IBodyAccessFilter
    {
        ...
        {
            base.GenerateSortKeysAndCopyReferences<FourBodySortKeyGenerator>(
                ref typeBatch,
        ...
        {
            base.VerifySortRegion<FourBodySortKeyGenerator>(ref typeBatch, bundleStartIndex, constraintCount, ref sortedKeys, ref sortedSourceIndices);
        }
